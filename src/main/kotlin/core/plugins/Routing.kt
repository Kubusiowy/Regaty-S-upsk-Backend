...
import com.example.features.categories.routes.categoryClientRoutes
...
import com.example.features.schools.routes.schoolClientRoutes
...
fun Application.configureRouting() {
    ...
    routing {
        ...
        categoryClientRoutes(categoryService)
        schoolClientRoutes(schoolService)
